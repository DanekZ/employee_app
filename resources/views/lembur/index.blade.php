...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Pengajuan Lembur Karyawan</h1>
            <p class="text-sm text-gray-500 mt-0.5">Daftar pengajuan kerja lembur dan status persetujuan.</p>
        </div>
        <a href="{{ route('lembur.create') }}" 
           class="inline-flex items-center justify-center px-4 py-2.5 bg-rose-800 hover:bg-rose-900 text-white font-medium rounded-xl shadow-sm transition-colors gap-2">
            <i class="fa-solid fa-plus"></i> Ajukan Lembur Baru
        </a>
    </div>
            ...
            <table class="w-full text-left text-sm text-gray-600">
                <thead class="bg-gray-50 text-xs uppercase text-gray-400 font-semibold border-b border-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-3">Alasan / Pekerjaan</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($overtimeRequests as $item)
                        <tr class="hover:bg-gray-50/80 transition-colors">
                            ...
                            <td class="px-6 py-4 text-gray-700 font-medium">{{ $item->lokasi_lembur }}</td>
